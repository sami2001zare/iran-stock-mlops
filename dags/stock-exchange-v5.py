...
# from airflow.providers.apache.hdfs.hooks.webhdfs import WebHDFSHook  # Uncomment if HDFS provider installed
...
def put_csv_to_hdfs(**kwargs):
    # Uncomment and implement when HDFS provider is available
...
def preprocess_convert_to_csv(**kwargs):
    ti = kwargs['ti']
    ds = kwargs['ds']                     # execution date as YYYY-MM-DD
